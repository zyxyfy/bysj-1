...
<div class="modal-header">
    ...
    <h4 class="modal-title">添加/编辑教师</h4>
</div>
<div class="modal-body">
    <form:form commandName="employee" action="${postActionUrl}"
               method="post" class="form-horizontal" onsubmit="return checkvalue()">
        ...
        <div class="form-group">
            <label for="inputEmail6" class="col-sm-2">联系电话：</label>
            <div class="col-sm-4">
                <form:input type="text" class="form-control" path="contact.moblie"/>
            </div>
        </div>
        <div class="form-group">
            <label for="inputEmail7" class="col-sm-2">QQ：</label>
            <div class="col-sm-4">
        ...
        <div class="form-group">
            <label for="inputEmail8" class="col-sm-2">邮箱：</label>
            <div class="col-sm-4">
